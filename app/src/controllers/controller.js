...
app.controller("auteurController", 
	...
	$http.get('app/resources/serveur.php', 
	{
		...
		$scope.newLastName = result.data[0].nom;
		//$scope.Name = result.data[0].prenom;
		$scope.newFunction = result.data[0].fonction;
	})
	$scope.editAuteur = function(id_auteur){
		console.log($scope.newFunction, $scope.newLastName,id_auteur);
